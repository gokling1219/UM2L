...
img = sio.loadmat('DFC2013_Houston.mat')['DFC2013_Houston']
gt = sio.loadmat('DFC2013_Houston_gt.mat')['DFC2013_Houston_gt']
...
def generate_PCAfeatures_for_traning(img, gt):
    ...
    f = h5py.File(
        './HS_' + str(count) + '_' + str(num_group) + '_' + str(PATCH_SIZE * 2) + '_' + str(
            PATCH_SIZE * 2) + '_3.h5',
        'w')
